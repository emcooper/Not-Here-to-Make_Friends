...
ActiveRecord::Schema.define(version: 12) do
  ...
  create_table "plays", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["season_type_id"], name: "index_plays_on_season_type_id"
  end
  ...
  create_table "seasons", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["season_type_id"], name: "index_seasons_on_season_type_id"
  end
  ...
  add_foreign_key "plays", "season_types"
  add_foreign_key "seasons", "season_types"
